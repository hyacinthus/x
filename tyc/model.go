...
type Company struct {
	...
	RegCapitalCurrency    string `json:"regCapitalCurrency"`    // 注册资本币种 人民币 美元 欧元 等(暂未使用)
	ActualCapitalCurrency string `json:"actualCapitalCurrency"` // 实收注册资本币种 人民币 美元 欧元 等(暂未使用)
