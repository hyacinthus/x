...
require (
	...
	github.com/GoogleCloudPlatform/cloudsql-proxy v0.0.0-20190610223153-dc577855e0bf // indirect
	...
	golang.org/x/build v0.0.0-20190616201242-c7084d3a2d60 // indirect
