...
require (
	...
	github.com/GoogleCloudPlatform/cloudsql-proxy v0.0.0-20190625211440-fa714b45b08a // indirect
	...
	golang.org/x/build v0.0.0-20190709001953-30c0e6b89ea0 // indirect
